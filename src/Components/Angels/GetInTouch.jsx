    ...
    return (
        <div className="relative min-h-96 flex items-center justify-center overflow-hidden">
            ...
            <div className="w-full max-w-6xl px-4 py-8 lg:px-0 mt-20 sm:mt-20">
                <div className="bg-[#10104b] rounded-[40px] overflow-visible w-full lg:w-3/4 mx-auto flex flex-col md:flex-row items-center justify-end p-6 lg:p-8 relative z-20">
                    ...
                    <div className="text-content w-full text-white pt-20 md:pt-0">
                        <h1 className='text-3xl font-bold font-Inter  text-center'>Get In Touch</h1>
                        <p className="text-base mb-6 text-center px-4 md:px-0">
